...
m = np.loadtxt('/home/wizkraft/openface-master/demos/matrix_'+movie+'.txt', usecols=range(128))
...
for i in range(1,n):
    print ("Image {:0.0f}".format(i)) , ("is Person number {:0.0f}".format(M[i]))
...
pyplot.title('Actor 1(Person '+str(int(index1))+')')
...
pyplot.title('Actor 2(Person '+str(int(index2))+')')
pyplot.xlabel('Time Interval')
pyplot.ylabel('Appearence Frequency')
...
pyplot.title('Actor 3(Person '+str(int(index3))+')')
pyplot.xlabel('Time Interval')
pyplot.ylabel('Appearence Frequency')
plt.bar(pos, a3, width, color='r')
...
pyplot.title('Actor 4(Person '+str(int(index4))+')')
pyplot.xlabel('Time Interval')
pyplot.ylabel('Appearence Frequency')
plt.bar(pos, a4, width, color='r')
