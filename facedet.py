...
if __name__ == '__main__':
    ...
    #Dabangg/Dabangg
    cam = cv2.VideoCapture('/home/wizkraft/Videos/The Prestige/The.Prestige.mkv')
    i=0;
    j=1
    M = [0] * 20
    ...
    while True:
        ...
        if i%20 == 0:
            ...
            if not type(rects) is list : 
                ...
                cv2.imwrite("/home/wizkraft/Desktop/Faces/Prestige/"+str(j)+".jpg",crop)              
                j = j+1
        vis = img.copy()
        ...
        i = i+1
        np.savetxt('/home/wizkraft/Desktop/Faces/Prestige/images.txt',M)
